export default function InnerAccidents() {
    return (
      <div className="max-w-6xl mx-auto w-full px-4 md:px-10 py-6">
        <h2 className="text-gray-800 text-lg font-bold">Accidents 2025</h2>
        ...
        <div className="flex flex-col md:flex-row mt-4 items-start gap-4">
          {/* Text Section */}
